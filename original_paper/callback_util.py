...
from original_paper.util import get_lids_random_batch
from original_paper.loss import cross_entropy, lid_paced_loss
from original_paper.lass_tf import lass
